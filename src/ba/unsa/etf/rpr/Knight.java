...
public class Knight extends ChessPiece {
    ...
    public boolean mozeLiNaPoziciju(String position) {
        return ((Math.abs(kolona(pozicija)-kolona(position))==2 && Math.abs(red(pozicija)-red(position))==1) || (Math.abs(kolona(pozicija)-kolona(position))==1 && Math.abs(red(pozicija)-red(position))==2));
    }
